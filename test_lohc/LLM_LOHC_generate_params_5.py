...
INITIAL_SET_SIZE = 7        # Number of molecules taken from CSV
MAX_ITERATIONS = 3         # Maximum number of iterations to generate new SMILES
TARGET_COUNT = 20           # Desired number of final new LOHC molecules
...
# File paths
SMILES_CSV_PATH = "Picked_from_paper.csv"
OUTPUT_CSV_PATH = "Argo_LOHC_generated_dry_run_withMP_more_attempts_second_try.csv"
