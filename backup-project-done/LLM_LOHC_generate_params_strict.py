...
INITIAL_SET_SIZE = 5        # Number of molecules taken from CSV
MAX_ITERATIONS = 30         # Maximum number of iterations to generate new SMILES
TARGET_COUNT = 50           # Desired number of final new LOHC molecules
...
OUTPUT_CSV_PATH = "Argo_LOHC_generated_strict.csv"
...
def calculate_hydrogen_weight(smiles):
    ...
    return h2_percent if h2_percent >= 6.5 else None
